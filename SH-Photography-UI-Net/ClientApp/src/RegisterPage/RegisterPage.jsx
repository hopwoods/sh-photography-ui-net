    ...
    render() {
        ...
        return (
            <div className="col-md-6 col-md-offset-3">
                <MetaTags>
                    <title>Stuart Hopwood Photography Registration Page</title>
                    <meta property="og:title" content="Stuart Hopwood Photography Registration Page"/>
                    <meta name="description" content="Registration page for Stuart Hopwood Photography users."/>
                </MetaTags>
                <h2>Register</h2>
